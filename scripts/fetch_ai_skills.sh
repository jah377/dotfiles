...
SKILLS_CLONE_DIR="$HOME/external-skills"
...
git clone https://github.com/anthropics/claude-plugins-official.git claude-plugins

git clone https://github.com/mattpocock/skills mattpocock-plugins
git clone https://github.com/multica-ai/andrej-karpathy-skills karpathy-skills

git clone https://github.com/dagster-io/skills.git dagster-skills
