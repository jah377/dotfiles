...
-- See https://github.com/hbbalfred/life.dev/blob/eedfb4ece77316eb82fabb98f0c008d1f05836c5/config/nvim/lua/hbb/core/lsp.lua#L19
-- See https://github.com/mplusp/minimal-nvim-0.11-lsp-setup/blob/main/lsp/lua_ls.lua
...
--       map("gR", ":LspRestart<CR>", "Restart LSP")
--       map("K", vim.lsp.buf.hover, "Documentation at Point")
--       map("gl", function()
