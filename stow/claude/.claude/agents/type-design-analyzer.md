...
description: >
  Analyzes type design: encapsulation, invariants, and enforcement. Use when
  adding or refactoring types, schemas, or similar constructs. Skip when the PR
...
<example>
Context: The user introduces a new domain type and wants sound invariants.
...
<example>
Context: The user is creating a pull request with several new data model types.
