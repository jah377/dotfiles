...
- Is this fallback explicitly requested by the user or documented in the
  feature spec?
...
Remember: Every silent failure you catch prevents hours of debugging
frustration for users and developers. Be thorough, be skeptical, and never let
an error slip through unnoticed.
