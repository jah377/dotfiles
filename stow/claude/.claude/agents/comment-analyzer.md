...
description: >
  Analyzes comments and docstrings for accuracy, completeness, and long-term
  maintainability. Use after large documentation additions, before PRs that
  change comments, or when auditing comment rot.
model: inherit
color: green
---
