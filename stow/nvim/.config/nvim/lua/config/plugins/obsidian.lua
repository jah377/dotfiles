...
return {
  ...
  config = function()
    require("obsidian").setup({
      ...
      -- New notes are captured in a staging directory before weekly review.
      notes_subdir = "tmp_notes",
      new_notes_location = "notes_subdir",

      -- Frontmatter is owned by templates, not generated by obsidian.nvim.
      disable_frontmatter = true, -- front-matter specified in templates
